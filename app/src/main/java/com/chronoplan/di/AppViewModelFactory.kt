...
class AppViewModelFactory : ViewModelProvider.Factory {
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        ...
        return when {
            modelClass.isAssignableFrom(AkunViewModel::class.java) -> AkunViewModel(useCase) as T
            modelClass.isAssignableFrom(AgendaViewModel::class.java) -> AgendaViewModel(useCase) as T
            modelClass.isAssignableFrom(NoteViewModel::class.java) -> NoteViewModel(useCase) as T
            modelClass.isAssignableFrom(SignInViewModel::class.java) -> SignInViewModel(useCase) as T
            modelClass.isAssignableFrom(SignUpViewModel::class.java) -> SignUpViewModel(useCase) as T
